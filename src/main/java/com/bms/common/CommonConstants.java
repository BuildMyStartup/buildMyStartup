...
public final class CommonConstants {
	 ...
	 */
	public static final String SPREADSHEET_CREATORS = "Creator";
	public static final String SPREADSHEET_IDEATORS = "Ideator";
	public static final String DATA_STORE_PATH = "C:/work/git/BuildMyStartup/buildMyStartup/src/main/resources/BMSDataStore.xls";//"src/main/resources/InvoicingDataStore.xls";
	...
	static{
		...
		tmpMap1.put(SKILLS 									, new Integer(16));
		tmpMap1.put(EXPERIENCE								, new Integer(17));
		tmpMap1.put(RATE 									, new Integer(18));
		tmpMap1.put(AVAILABILITYSTATUS 						, new Integer(19));
		tmpMap1.put(AVAILABILITYDATE 						, new Integer(20));
		
		creatorFields = Collections.unmodifiableMap(tmpMap1);
		...
		tmpMap2.put(PROJECTS 									, new Integer(16));
		
		ideatorFields = Collections.unmodifiableMap(tmpMap2);
