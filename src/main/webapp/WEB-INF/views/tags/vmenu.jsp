...
<ul class="nav nav-list">
	...
	<li class="nav-header"><a href="<c:url value="/displayCreator" />">Creator Profile</a></li>
	<li class="nav-header"><a href="<c:url value="/displayIdeator" />">Ideator Profile</a></li>
	<li class="nav-header"><a href="<c:url value="/addons" />">Addons</a></li>
</ul>