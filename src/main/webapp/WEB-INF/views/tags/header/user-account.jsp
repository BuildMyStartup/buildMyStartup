...
<body>
  ...
  <div class="tabbable" id="demo-tab"> <!-- Only required for left/right tabs -->
    ...
    <ul class="nav nav-tabs">
      ...
      <li><a href="#isettings" data-toggle="tab">Profile Settings</a></li>      
    </ul>  
    ...
    <div class="tab-pane" id="isettings">
        ...
        <ul>
          <li>
            <a id="invoicefee" class="textLink" href="<c:url value="/isettings?number=3&date=2014-12-27" />">Fee</a>
          </li>
          <li>
            <a id="reminderfee" class="textLink" href="<c:url value="/reminderfee?number=3&date=2014-12-27" />">Reminders</a>
          </li>
        </ul> 
      </div> 
    <!--tab-content-->
